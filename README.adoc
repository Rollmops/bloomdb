...
BloomDB is a powerful database migration tool that supports multiple database backends including PostgreSQL, SQLite, MySQL, and Oracle. It provides versioned and repeatable migrations with proper tracking and error handling.

image:demo.gif["BloomDB Demo", align="center"]
...
* **MySQL**: `mysql://user:password@tcp(localhost:3306)/database`
